...
$router->get('torneos/calendario',  'PublicoController', 'calendario');
...
// ─── ADMIN — USUARIOS ───────────────────────────────────────
// Organizadores (antes: admin/usuarios)
$router->get('admin/organizadores',                    'AdminController', 'usuarios');
$router->get('admin/organizadores/crear',              'AdminController', 'usuarioForm');
$router->post('admin/organizadores/crear',             'AdminController', 'usuarioGuardar');
$router->get('admin/organizadores/editar/{id}',        'AdminController', 'usuarioForm');
$router->post('admin/organizadores/editar/{id}',       'AdminController', 'usuarioGuardar');
$router->post('admin/organizadores/eliminar/{id}',     'AdminController', 'usuarioEliminar');
// Acciones de bloqueo/desbloqueo
$router->post('admin/organizadores/desbloquear/{id}', 'AdminController', 'usuarioDesbloquear');
$router->post('admin/organizadores/bloquear/{id}',    'AdminController', 'usuarioBloquear');
...
$router->post('admin/participantes/bloquear/{id}',   'AdminController', 'usuarioBloquear');
$router->post('admin/participantes/desbloquear/{id}','AdminController', 'usuarioDesbloquear');
